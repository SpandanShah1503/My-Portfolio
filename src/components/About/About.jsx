      ...
      <main>
        <div className="text-white max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
          ...
          <section id="about">
            ...
            <p>
              I’m Spandan, a passionate Computer Engineering student 💻 with a
              deep interest in Internet of Things (IoT) 🌐 and Cybersecurity 🔐.
              I love building technology that is powerful, secure, and
              sustainable.
            </p>
          ...
          <section id="work-experience">
            ...
            <div>
              <h3>FLY</h3>
              <p>
                <strong>Senior Design Engineer</strong> (2022 – Present)
              </p>
              <ul>
                <li>
                  Redesigned UI/UX resulting in 20% higher engagement and 30%
                  faster load times.
                </li>
                <li>
            ...
            <div>
              <h3>Creativ3</h3>
              <p>
                <strong>Lead Designer</strong> (2018 – 2022)
              </p>
              <ul>
                <li>
          ...
          <section id="studies">
            ...
            <ul>
              <li>
                <strong>Gujarat Technological University</strong> – Computer
                Engineering & Minor in Cybersecurity
              </li>
              <li>
                <strong>Build the Future</strong> – Online Marketing & Personal
                Branding
              </li>
            </ul>
          </section>
          ...
          <section id="social">
            ...
            <ul>
              ...
              <li>
                <a
                  href="https://www.linkedin.com/in/spandan-shah-57b276296/"
                  target="_blank"
                  rel="noreferrer"
                >
                  LinkedIn
